...
<style>
    ...
    .quick-box:hover { transform: translateY(-6px); }
    .quick-icon { font-size: 36px; margin-bottom: 8px; }
    .quick-title { font-size: 18px; font-weight: 800; color: #E0E7FF; }
    .quick-text { font-size: 15px; color: #dbeafe; }
...
if goal_progress >= 100:
    ...
    rec_color = "rec-red"
    rec_msg = "Goal bohot door hai!"
elif goal_progress < 90:
    rec_color = "rec-orange"
    rec_msg = "Bahut achha ja rahe hain!"
else:
    rec_color = "rec-green"
    rec_msg = "Goal qareeb hai!"
...
# ========================= EMERGENCY FUND — NEW SECTION =========================
st.markdown("<h3 style='text-align:center; color:white;'>Emergency Fund — 3 Months of Expenses</h3>", unsafe_allow_html=True)

required = monthly_expenses * 3
progress = min(100, (current_savings / required * 100)) if required > 0 else 0
...
center, _, graph = st.columns([1,1,2])
with graph:
...
st.markdown(
    f"<p style='text-align:center; color:#E0E7FF; font-size:20px; margin-top:-20px;'>"
    f"<b>{progress:.1f}% Ready</b> — Required Rs {required:,}</p>",
    unsafe_allow_html=True
)

st.markdown("<br><br>", unsafe_allow_html=True)

# ========================= QUICK INSIGHTS — NEW 4 CARDS =========================
st.markdown("<h3 style='text-align:center; color:white;'>Quick Insights</h3>", unsafe_allow_html=True)
...
with c1:
    ...
    <div class='quick-box'>
        ...
        <div class='quick-text'>Fund should cover 3 months</div>
    </div>
    """, unsafe_allow_html=True)
...
with c2:
    ...
    <div class='quick-box'>
        ...
        <div class='quick-text'>Track your monthly surplus</div>
    </div>
    """, unsafe_allow_html=True)
...
with c3:
    ...
    <div class='quick-box'>
        ...
        <div class='quick-text'>Smart progress tracking</div>
    </div>
    """, unsafe_allow_html=True)
...
with c4:
    ...
    <div class='quick-box'>
        ...
        <div class='quick-text'>Try reducing liabilities</div>
    </div>
    """, unsafe_allow_html=True)
