...
# FIXED + STYLISH RECOMMENDATION BOX
st.markdown(
    f"""
    <div class='goal-box'>
...
st.markdown(
    "<div style='text-align:center; background:rgba(255,255,255,0.12); padding:20px; "
    "border-radius:18px; color:#E0E7FF; font-size:17px;'>Inputs change karne ke baad "
    "sidebar se 'Analyze / Predict' zaroor dabana!</div>",
    unsafe_allow_html=True
)
