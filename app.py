...
# ========================= AI INSIGHTS SECTION =========================
st.markdown("<h3 id='insights' style='text-align:center; color:white; margin:40px 0 30px;'>AI Insights</h3>", unsafe_allow_html=True)
st.markdown("""
<div class='goal-box'>
    <div style='font-size:24px; font-weight:800; color:white; margin-bottom:16px;'>
        Coming Soon
...
# ========================= VISUALS SECTION =========================
st.markdown("<h3 id='visuals' style='text-align:center; color:white; margin:40px 0 30px;'>Visuals</h3>", unsafe_allow_html=True)
st.markdown("""
<div class='goal-box'>
    <div style='font-size:24px; font-weight:800; color:white; margin-bottom:16px;'>
        Coming Soon
